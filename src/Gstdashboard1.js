                ...
                <div class="wrapper">
                    ...
                    <nav id="sidebar">
                        ...
                        <ul class="list-unstyled components" style={{paddingTop:"0px"}}>
                            ...
                            <li>
                                <a class="dashboardanchorcolor"   href="#InvoiceSubmenu"  style={{padding:"5px 10px "}}   onClick={() => this.TaskMappingFunc()}><i class="fa  fa-institution" style={{fontSize:"26px",paddingRight:" 23px", border: "none"}}></i>Task Mapping</a>

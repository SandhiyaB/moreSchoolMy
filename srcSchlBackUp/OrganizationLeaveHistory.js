...
IndividualLeaveHistory(){
    ...
    ReactDOM.render(
            <Router>
              <div>  <Route path="/" component={IndividualLeaveHistory1}/>
 ...
 <h3 className="centerAlign" style={{ textAlign: "center" }}>Organizational Leave History For The Year  {this.state.year}</h3>
  ...
  <div id='horMenunew' >
          <ul id='horMenunew'  class="ulmenubar"style={{ backgroundColor: "#8811d6", padding: "10px 0px!important" }}>
            ...
            <li><a style={{ padding: "10px 0px" }}  onClick={() => this.IndividualLeaveHistory()} ><span class="glyphicon glyphicon-user"></span> Individual_History</a></li>
            <li><a style={{ padding: "10px 0px" }} onClick={() => this.OrganizationLeaveHistory()}><span class="glyphicon glyphicon-th-large"></span> Organizational_History </a></li>
          </ul>
